...
PREDICTED_LABELS = ["Affenhuahua dog","Afgan Hound dog","Akita dog", "Alaskan Malamute dog","American Bulldog dog","Auggie dog","Beagle dog","Belgian Tervuren dog","Bichon Frise dog","Bocker dog","Borzoi dog","Boxer dog","Bugg dog","Bulldog dog"]


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/010b17af-aac5-4c79-9c86-770bfd5115b8'
...
st.title("Dogs Breeds Image Classifier")#change according to your project
