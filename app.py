...
PREDICTED_LABELS = ["Afgan Hound dog","Alaskan Malamute dog"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/286e2b41-646a-4e00-8626-ca978d9cfd7e'  #Edit 2
...
st.title("Welcome to Dog Breed Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Dog Breed Image Classifier")#change according to your project   #edit 3
