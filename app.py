...
PREDICTED_LABELS = ["Affenhuahua dog","Afgan Hound dog","Akita dog", "Alaskan Malamute dog","American Bulldog dog","Auggie dog","Beagle dog","Belgian Tervuren dog","Bichon Frise dog","Bocker dog","Borzoi dog","Boxer dog","Bugg dog","Bulldog dog"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/010b17af-aac5-4c79-9c86-770bfd5115b8'  #Edit 2
...
st.title("Welcome to Dogs Breeds Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Dogs Breeds Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/Murali-9440350/aiclub")
  ...
  pdf_url = "https://raw.githubusercontent.com/Murali-9440350/aiclub/main/report.pdf"
